        ...
        return (
            <MainLayout title="Error">
                <div className="flex flex-col items-center justify-center h-full gap-4">
                    <p className={`text-xl font-semibold ${isDark ? 'text-white' : 'text-red-600'}`}>
    ...
    return (
        <MainLayout title={`Usuario: ${usuario.username}`}>
            <div className="max-w-4xl mx-auto w-full pb-20 animate-fade-in-up">
                ...
                {/* Header Card */}
                <div className={`${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} rounded-xl shadow-md border p-6 mb-6`}>
                    <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                        {/* Avatar */}
                        <div className={`w-20 h-20 rounded-full flex items-center justify-center text-3xl font-bold ${isDark ? 'bg-gray-700 text-white' : 'bg-red-100 text-red-900'}`}>
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex flex-wrap items-center gap-4">
                                <div className={`flex items-center gap-2 ${isDark ? 'text-white' : 'text-gray-600'}`}>
                                    <FontAwesomeIcon icon={faIdCard} className={`text-sm ${isDark ? 'text-white' : ''}`} />
                ...
                {/* Details Card */}
                <div className={`${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} rounded-xl shadow-md border p-6`}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {/* Email */}
                        <div className={`p-4 rounded-lg border ${isDark ? 'bg-gray-700/50 border-gray-700' : 'bg-gray-50 border-gray-100'}`}>
                            <div className="flex items-center gap-3 mb-2">
                                <div className={`w-10 h-10 rounded-full flex items-center justify-center ${isDark ? 'bg-gray-700 text-white' : 'bg-red-100 text-red-900'}`}>
                                    <FontAwesomeIcon icon={faEnvelope} className={isDark ? 'text-white' : ''} />
                                </div>
                                <div>
                                    <p className={`text-xs uppercase tracking-wide ${isDark ? 'text-white' : 'text-gray-500'}`}>
                                        Correo Electrónico
                                    </p>
                        ...
                        <div className={`p-4 rounded-lg border ${isDark ? 'bg-gray-700/50 border-gray-700' : 'bg-gray-50 border-gray-100'}`}>
                            <div className="flex items-center gap-3 mb-2">
                                <div className={`w-10 h-10 rounded-full flex items-center justify-center ${isDark ? 'bg-gray-700 text-white' : 'bg-red-100 text-red-900'}`}>
                                    <FontAwesomeIcon icon={faUser} className={isDark ? 'text-white' : ''} />
                                </div>
                                <div>
                                    <p className={`text-xs uppercase tracking-wide ${isDark ? 'text-white' : 'text-gray-500'}`}>
                                        Sexo
                        ...
                        <div className={`p-4 rounded-lg border ${isDark ? 'bg-gray-700/50 border-gray-700' : 'bg-gray-50 border-gray-100'}`}>
                            <div className="flex items-center gap-3 mb-2">
                                <div className={`w-10 h-10 rounded-full flex items-center justify-center ${isDark ? 'bg-gray-700 text-white' : 'bg-red-100 text-red-900'}`}>
                                    <FontAwesomeIcon icon={faIdCard} className={isDark ? 'text-white' : ''} />
                                </div>
                                <div>
                                    <p className={`text-xs uppercase tracking-wide ${isDark ? 'text-white' : 'text-gray-500'}`}>
                                        Nombre de Usuario
                    ...
                    <div className={`mt-6 pt-6 border-t ${isDark ? 'border-gray-700' : 'border-gray-100'}`}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <p className={`text-xs uppercase tracking-wide mb-2 ${isDark ? 'text-white' : 'text-gray-500'}`}>
                                    Rol en el Sistema
                                </p>
