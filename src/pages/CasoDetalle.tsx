  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      if (editFormData.idTribunal) {
        const trib = tribunales.find((t) => t.id === editFormData.idTribunal);
        if (trib) updatedCaso.nombreTribunal = trib.nombre;
      }
                        ...
                        <div className="relative w-full">
                          ...
                          <div
                            className={`absolute left-8 top-0 bottom-0 w-0.5 ${isDark
                              ? 'bg-white'
                              : 'bg-linear-to-b from-red-900 via-red-600 to-gray-300'
                              }`}
                          ></div>
                              ...
                              return (
                                <div key={evento.id} className="relative w-full pl-20 pb-6">
                                  ...
                                  <div
                                    ...
                                    className={`w-full rounded-lg shadow-md border-l-4 ${esAccionPendiente
                                  ...
                                  >
                                    ...
                                    <div className="flex justify-between items-start mb-3">
                                      <div className="flex items-center gap-2">
                                        ...
                                        {esAccionPendiente && (
                                          <span
                                            className={`text-xs font-bold px-2 py-1 rounded-full uppercase tracking-wide ${isDark
                                    ...
                                    {/* Título */}
                                    <div className="mb-2">
                                      <h4 className={`font-bold text-lg ${esAccionPendiente
              ...
              <div>
                ...
                <CustomSelect
                  options={[
                    ...
                    ...tribunales.map((t) => ({ value: t.id, label: t.nombre })),
                  ]}
