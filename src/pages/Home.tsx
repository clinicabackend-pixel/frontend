      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        <div className="md:col-span-2 lg:col-span-2 grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center justify-center text-center hover:shadow-md transition-shadow">
            <div className="w-12 h-12 bg-red-50 text-red-900 rounded-full flex items-center justify-center text-xl mb-3">
              <FontAwesomeIcon icon={faBriefcase} />
            </div>
            <h3 className="text-3xl font-bold text-gray-800">12</h3>
            <p className="text-sm text-gray-500 font-medium">Mis Casos Activos</p>
          </div>
          {/* Card 2 */}
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center justify-center text-center hover:shadow-md transition-shadow">
            <div className="w-12 h-12 bg-yellow-50 text-yellow-600 rounded-full flex items-center justify-center text-xl mb-3">
              <FontAwesomeIcon icon={faClock} />
            </div>
            <h3 className="text-3xl font-bold text-gray-800">5</h3>
            <p className="text-sm text-gray-500 font-medium">Pendientes Revisión</p>
          </div>
          {/* Card 3 */}
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center justify-center text-center hover:shadow-md transition-shadow">
            <div className="w-12 h-12 bg-green-50 text-green-600 rounded-full flex items-center justify-center text-xl mb-3">
              <FontAwesomeIcon icon={faCheckCircle} />
            </div>
            <h3 className="text-3xl font-bold text-gray-800">8</h3>
            <p className="text-sm text-gray-500 font-medium">Cerrados este mes</p>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col justify-between">
          ...
          <div className="space-y-3">
            <button onClick={() => navigate('/solicitantes?mode=create')} className="w-full flex items-center gap-3 p-3 text-left rounded-lg hover:bg-red-50 text-gray-700 hover:text-red-900 transition-colors group">
        ...
        <div className="md:col-span-1 md:row-span-2 bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden flex flex-col h-full">
          <div className="p-5 border-b border-gray-100 bg-gray-50/50">
            <h3 className="text-lg font-bold text-gray-800">Próximos Vencimientos</h3>
          </div>
          <div className="flex-1 overflow-y-auto p-4 space-y-4 max-h-[500px]">
            {/* Item Agenda 1 - Alta Prioridad */}
            <div className="pl-4 border-l-4 border-red-500 bg-red-50/30 p-3 rounded-r-lg">
              <p className="text-xs text-red-600 font-bold mb-1">MAÑANA, 09:00 AM</p>
              <h4 className="text-sm font-semibold text-gray-800">Audiencia Preliminar</h4>
              <p className="text-xs text-gray-600">Caso #2026-045 - Familia Gomez</p>
            </div>
            {/* Item Agenda 2 - Media Prioridad */}
            <div className="pl-4 border-l-4 border-yellow-400 bg-yellow-50/30 p-3 rounded-r-lg">
              <p className="text-xs text-yellow-600 font-bold mb-1">JUEVES 21, 02:00 PM</p>
              <h4 className="text-sm font-semibold text-gray-800">Entrega de Documentos</h4>
              <p className="text-xs text-gray-600">Caso #2026-089 - Sra. Martinez</p>
            </div>
            {/* Item Agenda 3 - Baja Prioridad */}
            <div className="pl-4 border-l-4 border-blue-400 bg-blue-50/30 p-3 rounded-r-lg">
              <p className="text-xs text-blue-600 font-bold mb-1">LUNES 25, 10:00 AM</p>
              <h4 className="text-sm font-semibold text-gray-800">Reunión de Equipo</h4>
              <p className="text-xs text-gray-600">Revisión mensual de casos</p>
            </div>
            {/* Item Agenda 4 */}
            <div className="pl-4 border-l-4 border-gray-300 bg-gray-50 p-3 rounded-r-lg">
              <p className="text-xs text-gray-500 font-bold mb-1">VIERNES 29</p>
              <h4 className="text-sm font-semibold text-gray-800">Cierre de Actas</h4>
              <p className="text-xs text-gray-600">Todos los expedientes</p>
            </div>
          </div>
          <div className="p-3 border-t border-gray-100 text-center">
            <button className="text-xs font-semibold text-red-900 hover:text-red-700 transition-colors">
              Ver toda la agenda
            </button>
          </div>
        </div>
            ...
            {[40, 65, 30, 80, 55, 90, 45].map((height, i) => (
              <div key={i} className="flex flex-col items-center gap-2 w-full group cursor-pointer">
                <div className="relative w-full bg-gray-100 rounded-t-lg overflow-hidden h-40 flex items-end">
                  <div
                    style={{ height: `${height}%` }}
                    className={`w-full ${i === 5 ? 'bg-red-900' : 'bg-red-200 group-hover:bg-red-300'} rounded-t-lg transition-all duration-300`}
                  ></div>
                </div>
                <span className={`text-xs ${i === 5 ? 'font-bold text-red-900' : 'text-gray-400'}`}>
